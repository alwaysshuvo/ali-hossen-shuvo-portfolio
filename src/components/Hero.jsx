...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 bg-gradient-dark relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="relative inline-block">
            ...
            <div className="relative w-40 h-40 mx-auto bg-gradient-to-b from-primary to-secondary rounded-full p-1">
        ...
        >
          Junior Full Stack Developer <span className="text-primary">(MERN)</span>
        </motion.p>
        ...
        >
          Crafting beautiful, responsive web applications with React, Node.js, MongoDB, and Express. 
